...
public class arr_tictactoe {
    ...
    public static void main(String[] args) {
        ...
        //가로 저장
        String[] xArr1 = new String[3];
        String[] xArr2 = new String[3];
        String[] xArr3 = new String[3];//가로 저장
        //세로 저장
        String[] yArr1 = new String[3];
        String[] yArr2 = new String[3];
        String[] yArr3 = new String[3];//세로 저장
        //대각선 저장
        String[] dArr1 = new String[3];
        String[] dArr2 = new String[3];
        //3개 일치여부판단
        boolean xcheck1 = false;
        boolean xcheck2 = false;
        boolean xcheck3 = false;
        boolean ycheck1 = false;
        boolean ycheck2 = false;
        boolean ycheck3 = false;
        boolean dcheck1 = false;
        boolean dcheck2 = false;


        System.out.println("[Tic Tac Toe GAME]");
        System.out.println("===========<주의사항>===========\n# 위치를 입력해주세요.\nex)[(0-2 범위안에서) (0-2 범위안에서)]");
        ...
        while (true) {
            ...
            Thread.sleep(10000);//jar파일로 빌드시 종료 딜레이
    }catch (Exception e){
